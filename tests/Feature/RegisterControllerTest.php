...
class RegisterControllerTest extends TestCase
{
    ...
    /**
     * 新規会員登録画面のURLにアクセスして新規会員登録画面が表示されるかテスト
     *
     * @return void
     */
    public function test_新規会員登録画面のURLにアクセスして新規会員登録画面が表示される()
    {
    ...
    /**
     * 会員登録に成功した後はトップ画面が表示されるかテスト
     *
     * @return void
     */
    public function test_会員登録に成功した後はトップ画面が表示される()
    {
        // fakerでパスワード作成
        $password = bcrypt($this->faker->password);
        // RegisterController@registerにダミー会員情報を引き連れてアクセスする
    ...
    /**
     * 名前を入力しないで会員登録しようとするとエラーメッセージが表示されるかテスト
     *
     * @return void
     */
    public function test_名前を入力しないで会員登録しようとするとエラーメッセージが表示される()
    {
        // RegisterController@registerにダミー会員情報を引き連れてアクセスする
        // ただし名前は未入力
        $response = $this->post('/signup', [
    ...
    /**
     * メールアドレスを入力しないで会員登録しようとするとエラーメッセージが表示されるかテスト
     *
     * @return void
     */
    public function test_メールアドレスを入力しないで会員登録しようとするとエラーメッセージが表示される()
    {
        // RegisterController@registerにダミー会員情報を引き連れてアクセスする
        // ただしメールアドレスは未入力
        $response = $this->post('/signup', [
    ...
    /**
     * パスワードを入力しないで会員登録しようとするとエラーメッセージが表示されるかテスト
     *
     * @return void
     */
    public function test_パスワードを入力しないで会員登録しようとするとエラーメッセージが表示される()
    {
        // RegisterController@registerにダミー会員情報を引き連れてアクセスする
        // ただしパスワードは未入力
        $response = $this->post('/signup', [
     ...
     /**
     * パスワードを5文字未満で会員登録しようとするとエラーメッセージが表示されるかテスト
     *
     * @return void
     */
    public function test_パスワードを5文字未満で会員登録しようとするとエラーメッセージが表示される()
    {
        // RegisterController@registerにダミー会員情報を引き連れてアクセスする
        // ただしパスワードは5文字未満
        $response = $this->post('/signup', [
    ...
    /**
     * 2つのパスワードが違う状態で会員登録しようとするとエラーメッセージが表示されるかテスト
     *
     * @return void
     */
    public function test_2つのパスワードが違う状態で会員登録しようとするとエラーメッセージが表示される()
    {
        // RegisterController@registerにダミー会員情報を引き連れてアクセスする
        // ただし2つのパスワードが異なる
        $response = $this->post('/signup', [
