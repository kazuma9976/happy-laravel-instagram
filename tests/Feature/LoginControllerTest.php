...
class LoginControllerTest extends TestCase
{
    ...
    /** @test */
    public function 会員登録しておいたemailアドレスとパスワードでログインできる()
    {
        // fakerを使ってダミー情報作成
    ...
    /** @test */
    public function 会員登録したものと違うメールアドレスでログインしようとしてもログインできない()
    {
        // fakerを使ってダミー情報作成
        $email = $this->faker->unique()->email;
        $password = $this->faker->password;
    ...
    /** @test */
    public function 会員登録したものと違うパスワードでログインしようとしてもログインできない()
    {
        // fakerを使ってダミー情報作成
        $email = $this->faker->unique()->email;
        $password = $this->faker->password;
    ...
    /** @test */
    public function 会員登録したものと異なるメールアドレスでログインしようとするとエラーメッセージが表示される()
    {
        // fakerを使ってダミー情報作成
        $email = $this->faker->unique()->email;
        $password = $this->faker->password;
    ...
    /** @test */
    public function 会員登録したものと異なるパスワードでログインしようとするとエラーメッセージが表示される()
    {
        // fakerを使ってダミー情報作成
        $email = $this->faker->unique()->email;
        $password = $this->faker->password;
    ...
    /** @test */
    public function ログアウトするとログイン前の画面のリダイレクトする()
    {
        // factoryを使ってダミー会員作成
        $user = factory(User::class)->create();
        // その会員を認証状態にセット
